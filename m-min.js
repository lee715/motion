...
(function() {
  ...
  FreeFall = (function(_super) {
    ...
    FreeFall.prototype._check = function(x, method) {
      ...
      switch (this.opts.type) {
        case 'decay':
          if(this._t<0.01) return this.ym*this.times;
          ...
          if (x > this._t) {
            ...
            if (this._derec) {
              ...
              this.yn = vt * vt / 20;
              console.log('-----------------------------');
              console.log(this.a, this.b, this.c, this._t, this._getY(this._t));
            } else {
              this.a = 5;
              this.b = 0;
              this.c = this.ym - this.yn;
              console.log('-----------------------------');
              console.log(this.a, this.b, this.c, this._t, this._getY(0));
            }
          }
